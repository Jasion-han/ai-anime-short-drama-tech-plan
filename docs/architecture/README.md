...
- 当前仓库试跑模式：主执行 AI 直接使用根目录文档和 `project/`
- 未来内部系统模式：数据库是真相，`project/` 是镜像 / 导出层，系统实现参考本目录文档

若讨论“AI 当前如何执行项目”，优先看根目录文档。

若讨论“公司如何把这套方法做成内部生产系统”，优先看本目录文档。
...
- 当前仓库试跑时，AI 直接读写仓库根目录的 `project/`
- 未来内部系统落地时，数据库是真相，`project/` 是镜像 / 导出层
